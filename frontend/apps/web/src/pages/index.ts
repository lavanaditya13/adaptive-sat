...
export { PracticeSubjectPage } from './PracticeSubjectPage/PracticeSubjectPage';
export { PracticeHomePage } from './PracticeHomePage/PracticeHomePage';
export { PracticeDomainsPage } from './PracticeDomainsPage/PracticeDomainsPage';
export { PracticeSkillsPage } from './PracticeSkillsPage/PracticeSkillsPage';
export { PracticeConfirmPage } from './PracticeConfirmPage/PracticeConfirmPage';
