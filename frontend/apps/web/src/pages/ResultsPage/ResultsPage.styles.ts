export const CONTAINER_STYLES = 'max-w-[640px] mx-auto px-5 py-6 pb-10 space-y-7';
export const EMPTY_CONTAINER_STYLES = 'max-w-md mx-auto p-6 min-h-[60vh] flex flex-col justify-center';
export const EMPTY_CARD_STYLES =
  'bg-surface-card border border-hairline p-6 text-center space-y-4 rounded-2xl';
